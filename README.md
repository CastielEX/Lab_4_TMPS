...
The Subject class represents a subject that maintains a list of observers and allows observers to subscribe (attach) and unsubscribe (detach) to it.
...
The Context class represents a context that uses a strategy.
...
The Command class defines an abstract command that needs to be implemented by concrete command classes.
...
The Context class represents a context that can change its behavior based on its internal state.
